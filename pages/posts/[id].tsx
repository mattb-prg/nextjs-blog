...
export default function Post({ post }) {
    ...
    const imageSrc = require('../../public' + thumbnail + '?resize&sizes[]=500&sizes[]=600&format=webp')
    const imageSizes = '(min-width: 600px): 600px, 100vw'
    const profileImgSrc = require('../../public/images/profile.jpg?resize&size=50&format=webp')
    return (
        <Layout>
            <Head>
            ...
            <article className="container mx-auto flex flex-col items-center space-y-6">
                ...
                <div className="max-w-[65ch] space-y-6">
                    ...
                    <div className="flex h-20 space-x-3">
                        <div>
                            <img className="rounded-full flex-grow" src={profileImgSrc.src} height={50} width={50} alt={'Profile'} />
                        </div>
